...
<head>
    ...
    <!-- current page css -->
    <link rel="stylesheet" href="landing_css/editBirthdate.css?v=<?php echo time(); ?>">
        ...
        <div class="wrapper-main profile-main-flex">
            <div class="personal-info-container">
                ...
                <div class="new-personal-info">
                    <form method="post" action="update_birthdate.php" id="updateBirthdateForm">
                        <div class="new-info">
                            <label for="new-birthdate">Enter New Birthdate:</label>
                            <input type="date" name="new-birthdate" id="new-birthdate" value="<?php echo $birthdate; ?>" required>
                            <label for="password">Enter Password:</label>
                            <input type="password" name="password" id="password" required>
                        </div>
                        <div class="button-container">
                            <button type="submit" id="save"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                            <button type="button" id="cancel" onclick="window.location.href='profile.php';">Cancel</button>
                        </div>
                    </form>
                </div>
                <script>
                    document.getElementById('updateBirthdateForm').addEventListener('submit', function (event) {
                        event.preventDefault(); // Prevent the default form submission
                        const formData = new FormData(this);
                        fetch('update_birthdate.php', {
                            method: 'POST',
                            body: formData
                        })
