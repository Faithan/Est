...
<head>
    ...
    <!-- current page css -->
    <link rel="stylesheet" href="landing_css/editContactNumber.css?v=<?php echo time(); ?>">
    <link rel="shortcut icon" href="system_images/Picture4.png" type="image/png">
    <title>Edit Contact Number</title>
        ...
        <div class="wrapper-main profile-main-flex">
            ...
            <div class="personal-info-container">
                ...
                <div class="personal-info">
                    <div class="info">
                        <p><i class="fa-solid fa-phone"></i> Contact Number</p>
                ...
                <div class="new-personal-info">
                    <form method="post" action="update_contact_number.php" id="updateContactNumberForm">
                        <div class="new-info">
                            <label for="new-contact-number">Enter New Contact Number:</label>
                            <input type="number" name="new-contact-number" id="new-contact-number" value="<?php echo $contact_number; ?>" required>
                ...
                <script>
                    document.getElementById('updateContactNumberForm').addEventListener('submit', function (event) {
                        event.preventDefault(); // Prevent the default form submission

                        const formData = new FormData(this);

                        fetch('update_contact_number.php', {
                            method: 'POST',
                            body: formData
                        })
