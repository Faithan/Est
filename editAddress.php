...
<head>
    ...
    <!-- current page css -->
    <link rel="stylesheet" href="landing_css/editAddress.css?v=<?php echo time(); ?>">
        ...
        <div class="wrapper-main profile-main-flex">
            <div class="personal-info-container">
                ...
                <div class="new-personal-info">
                    <form method="post" action="update_address.php" id="updateAddressForm">
                        <div class="new-info">
                            <label for="new-address">Enter New Address:</label>
                            <input type="text" name="new-address" id="new-address" value="<?php echo $address; ?>" required>
